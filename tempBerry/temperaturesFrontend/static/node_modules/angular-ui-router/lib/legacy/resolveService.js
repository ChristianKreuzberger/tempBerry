...
var $resolve = {
    ...
    * ### Not bundled by default
    ...
    resolve: function (invocables, locals, parent) {
        ...
        var parentNode = new ui_router_core_1.PathNode(new ui_router_core_1.State({ params: {}, resolvables: [] }));
        var node = new ui_router_core_1.PathNode(new ui_router_core_1.State({ params: {}, resolvables: [] }));
