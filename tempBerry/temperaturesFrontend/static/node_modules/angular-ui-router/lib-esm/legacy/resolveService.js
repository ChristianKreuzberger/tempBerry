/** @module ng1 */ /** */
import { State, PathNode, ResolveContext, mapObj, resolvablesBuilder } from "ui-router-core";
...
var $resolve = {
    ...
    * ### Not bundled by default
    ...
    resolve: function (invocables, locals, parent) {
        ...
        var parentNode = new PathNode(new State({ params: {}, resolvables: [] }));
        var node = new PathNode(new State({ params: {}, resolvables: [] }));
